    ...
    <>
      <div className="max-h-screen flex flex-col justify-center py-4 sm:px-6 lg:px-8 mt-16 md:mt-auto">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <img
            className="h-22 rounded mx-auto block"
        ...
        <div className="mt-4 sm:mx-auto sm:w-full sm:max-w-md shadow-md">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div className="mt-4 relative flex justify-center text-sm rounded-md shadow-sm text-sm font-semibold text-gray-600 bg-gray-100 hover:bg-gray-50 border border-gray-300">
              <GoogleLoginComp />
            </div>
            <div className="mt-6">
              <div className="relative">
